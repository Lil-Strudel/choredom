...
export const ScribbleButton = ({ children, ...props }: ScribbleButtonProps) => {
  ...
  return (
    <motion.button
      ...
      {...props}
      className={twMerge(
        "border-[3px] border-[#4f3c33] bg-white p-2 [border-bottom-left-radius:15px_255px] [border-bottom-right-radius:225px_15px] [border-top-left-radius:255px_15px] [border-top-right-radius:15px_225px]",
        props.className,
      )}
      initial={{
        scale: 1,
